...
| 0035 | Player interaction / click | **ported** to active `patches/server` (GameMode + packet listener) |
...
Active NeoForge hooks that *do* apply: `patches/server/0020` through the current Eturlia numbered patches.
