...
import com.eturlia.compat.create.network.RegionAwareKineticNetwork;
import com.eturlia.compat.create.handlers.ContraptionRegionHandler;
import com.eturlia.compat.create.handlers.RegionizedProjectileHandler;
import com.eturlia.compat.create.handlers.CrossRegionExplosionHandler;
...
/**
 * Main entry point for the Eturlia compatibility layer for Create and Create Big Cannons.
 *
 ...
 */
@Mod(EturliaCompatCreate.MOD_ID)
public class EturliaCompatCreate {

    /** Mod identifier used in {@code neoforge.mods.toml} and registration. */
    public static final String MOD_ID = "eturlia_compat_create";
     ...
     */
    public EturliaCompatCreate(IEventBus modEventBus, ModContainer modContainer) {
        this.modContainer = modContainer;

        LOGGER.info("[EturliaCompatCreate] Initializing Create + Create Big Cannons compat for Folia regionized server");
    ...
    private void onCommonSetup(final FMLCommonSetupEvent event) {
        LOGGER.info("[EturliaCompatCreate] Common setup: registering region-aware handlers");
        ...
        event.enqueueWork(() -> {
            ...
            LOGGER.info("[EturliaCompatCreate] All region-aware handlers registered successfully");
        });
    }
}
