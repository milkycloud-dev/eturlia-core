package com.eturlia.compat.sable.physics;
 ...
 * </ul>
 *
 * @see com.eturlia.compat.sable.EturliaCompatSable
 */
public final class JNIThreadSafetyAuditor {
    ...
    public static void installHooks() {
        ...
        // These hooks use the mixin plugin defined in eturlia-compat-sable.mixins.json
    }
