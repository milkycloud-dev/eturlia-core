...
public final class RegionAwareEventBus {
    ...
    private static final Logger LOGGER = Logger.getLogger("EturliaEventBus");
     ...
     * {@code eturlia.event.validation} at server startup, or can be set
    ...
    public enum ValidationMode {
        ...
        private static final String PROPERTY = "eturlia.event.validation";

        /**
         * Reads the validation mode from the system property
         * {@code eturlia.event.validation}. Defaults to {@link #WARN}.
         *
     ...
     * EventBus guavaBus = new EventBus("Eturlia-RegionAware");
